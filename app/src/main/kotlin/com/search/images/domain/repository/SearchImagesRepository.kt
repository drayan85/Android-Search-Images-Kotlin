 ...
 */
package com.search.images.domain.repository
...
interface SearchImagesRepository {
    ...
    fun searchImages(query: String, page: Int, perSize: Int, isInternetAvailable: Boolean) : Either<Failure, ImageSearchResponse>
}